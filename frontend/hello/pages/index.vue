<template>
  <div class="bg-gray-100 h-screen">
    <div class="container mx-auto flex flex-col items-center py-12 sm:py-24 h-screen  z-index-10 justify-center">
...
Simply answer the following questions about your goals and data, and we will recommend you an appropriate test.
        ...
        <p
          ...
          "
        >
          Caution: the statistical information provided is not exhaustive and the recommendations may deviate from what would be most appropriate in your situation.        </p>
      </div>
